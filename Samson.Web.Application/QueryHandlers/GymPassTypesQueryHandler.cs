...
{
    [QueryHandler]
    public class GymPassTypesQueryHandler : IRequestHandler<GymPassTypesQuery, List<GymPassTypeDto>>
    {
        /// <summary>
        ...
        public Task<List<GymPassTypeDto>> Handle(GymPassTypesQuery query, CancellationToken cancellationToken)
        {
            return _readModel.GetPassTypes();
        }
    }
}